...
var content__5702 = domina.xpath.xpath.call(null,"//div[@id='content']");

domina.destroy_children_BANG_.call(null,content__5702);
domina.set_html_BANG_.call(null,content__5702,form_html);
domina.append_BANG_.call(null,content__5702,greeting_html);
...
var e__5703 = cljs.core.ObjMap.fromObject(["﷐'effect","﷐'end","﷐'time"],{"﷐'effect":"﷐'fade","﷐'end":0,"﷐'time":500});

return one.browser.animation.play_animation.call(null,(function (){
return one.browser.animation.parallel.call(null,one.browser.animation.bind.call(null,one.sample.animation.form,e__5703),one.browser.animation.bind.call(null,one.sample.animation.label,e__5703),one.browser.animation.bind.call(null,one.sample.animation.cloud,cljs.core.ObjMap.fromObject(["﷐'effect","﷐'time"],{"﷐'effect":"﷐'color","﷐'time":500}),cljs.core.ObjMap.fromObject(["﷐'effect","﷐'time"],{"﷐'effect":"﷐'fade-in-and-show","﷐'time":600})));
...
var button__5704 = domina.by_id.call(null,id);

goog.dom.forms.setDisabled.call(null,button__5704,true);
return one.browser.animation.play.call(null,button__5704,cljs.core.ObjMap.fromObject(["﷐'effect","﷐'end","﷐'time"],{"﷐'effect":"﷐'fade","﷐'end":0.2,"﷐'time":400}));
});
/**
...
var button__5705 = domina.by_id.call(null,id);

goog.dom.forms.setDisabled.call(null,button__5705,false);
return one.browser.animation.play.call(null,button__5705,one.sample.animation.fade_in);
});
