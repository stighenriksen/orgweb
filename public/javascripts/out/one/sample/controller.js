...
*/
one.sample.controller.action = (function (){var method_table__513__auto____5712 = cljs.core.atom.call(null,cljs.core.ObjMap.fromObject([],{}));
var prefer_table__514__auto____5713 = cljs.core.atom.call(null,cljs.core.ObjMap.fromObject([],{}));
var method_cache__515__auto____5714 = cljs.core.atom.call(null,cljs.core.ObjMap.fromObject([],{}));
var cached_hierarchy__516__auto____5715 = cljs.core.atom.call(null,cljs.core.ObjMap.fromObject([],{}));
var hierarchy__517__auto____5716 = cljs.core.get.call(null,cljs.core.ObjMap.fromObject([],{}),"﷐'hierarchy",cljs.core.global_hierarchy);

return (new cljs.core.MultiFn("action","﷐'type","﷐'default",hierarchy__517__auto____5716,method_table__513__auto____5712,prefer_table__514__auto____5713,method_cache__515__auto____5714,cached_hierarchy__516__auto____5715));
})();
...
return one.browser.remote.request.call(null,f,cljs.core.str.call(null,one.sample.controller.host.call(null),"/remote"),"﷐'method","POST","﷐'on-success",(function (p1__5717_SHARP_){
return on_success.call(null,cljs.reader.read_string.call(null,"﷐'body".call(null,p1__5717_SHARP_)));
}),"﷐'on-error",(function (){
...
cljs.core._add_method.call(null,one.sample.controller.action,"﷐'greeting",(function (p__5719){
var map__5720__5721 = p__5719;
var map__5720__5722 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__5720__5721))?cljs.core.apply.call(null,cljs.core.hash_map,map__5720__5721):map__5720__5721);
var name__5723 = cljs.core.get.call(null,map__5720__5722,"﷐'name");

return one.sample.controller.remote.call(null,"﷐'add-name",cljs.core.ObjMap.fromObject(["﷐'name"],{"﷐'name":name__5723}),(function (p1__5718_SHARP_){
return one.sample.controller.add_name_callback.call(null,name__5723,p1__5718_SHARP_);
}));
}));
