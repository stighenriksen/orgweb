...
return cljs.core.into.call(null,cljs.core.ObjMap.fromObject([],{}),cljs.core.map.call(null,(function (p__5849){
var vec__5850__5851 = p__5849;
var k__5852 = cljs.core.nth.call(null,vec__5850__5851,0,null);
var v__5853 = cljs.core.nth.call(null,vec__5850__5851,1,null);

return cljs.core.Vector.fromArray([cljs.core.keyword.call(null,k__5852.toLowerCase()),v__5853]);
...
var h__5854 = (cljs.core.truth_(goog.history.Html5History.isSupported.call(null))?(new goog.history.Html5History()):(new goog.History()));

clojure.browser.event.listen.call(null,h__5854,"navigate",(function (e){
